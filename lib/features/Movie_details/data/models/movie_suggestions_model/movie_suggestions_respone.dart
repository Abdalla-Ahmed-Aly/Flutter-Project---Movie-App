class MovieSuggestionsRespone {
  MovieSuggestionsRespone({
      this.status,
      this.statusMessage,
      this.data,
      });

  MovieSuggestionsRespone.fromJson(dynamic json) {
    status = json['status'];
  ...
  Data.fromJson(dynamic json) {
    ...
    if (json['movies'] != null) {
      ...
      json['movies'].forEach((v) {
        movies?.add(MovieSuggestions.fromJson(v));
      });
    }
  }
  int? movieCount;
  List<MovieSuggestions>? movies;
